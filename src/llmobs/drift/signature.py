...
_SKELETON_KEEP = {
    "what", "who", "when", "where", "why", "how", "which", "is", "are", "was", "were",
    "do", "does", "did", "can", "could", "should", "would", "will", "the", "a", "an",
    "of", "in", "on", "for", "to", "from", "with", "and", "or", "not", "no", "if",
    "this", "that", "these", "those", "i", "you", "we", "they", "it", "me", "my",
}
